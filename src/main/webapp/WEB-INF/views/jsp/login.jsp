    ...
    <style>
        ...
        * {
        ...
        body {
            ...
            background: -webkit-radial-gradient(0% 100%, rgba(104, 128, 138, .4) 10%, rgba(138, 114, 76, 0) 40%), -o-linear-gradient(top, rgba(57, 173, 219, .25) 0%, rgba(42, 60, 87, .4) 100%), -o-linear-gradient(-45deg, #670d10 0%, #092756 100%);
...
<form name='login'  method='POST' action="/">
    <table class='login'>
        <tr>
            ...
            <td><input path="username" type='text' name='username' value='' required='required' /></td>
        </tr>
        <tr>
            <td><label path="password">Password:</label></td>
            <td><input path="password" type='password' name='password' required='required'/></td>
        </tr>
        <tr>
            <td colspan='2'>
                <input name="submit" type="submit" value="submit" class="btn btn-primary btn-block btn-large"/></td>
        </tr>
    </table>
